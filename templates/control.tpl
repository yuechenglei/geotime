    ...
    <span>Swith</span>
         ...
         <div>
                     	<label class="radio-inline" id="Swith3d">
                     		<input type="radio" name="optionsRadiosinline" id="2dTo2d" value="option1" checked> 2D
                     	</label>
                     	<label class="radio-inline">
                     		<input type="radio" name="optionsRadiosinline" id="2dTo3d"  value="option2"> 3D
                     	</label>
          </div>
        ...
        <div>
            <input type="checkbox" id="airplane-check">
            <span>Airplane</span>
            </br>
        </div>
